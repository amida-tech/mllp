...
function MLLPServer(host, port, logger) {
    ...
    var Server = net.createServer(function (sock) {
        ...
        function ackn(data, ack_type) {
            ...
            var receiverApp = data[0][5];
            var receiverInst = data[0][6];
            var senderApp = data[0][3];
            var senderInst = data[0][4];

            header[0][3] = receiverApp;
            header[0][4] = receiverInst;
            header[0][5] = senderApp;
            header[0][6] = senderInst;
